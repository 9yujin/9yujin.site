...
[**\[React\] Docker + Nginx + Github Actions 프로젝트 배포하기 (1)**](https://9yujin.tistory.com/47)

리액트 프로젝트를 깃허브 액션을 통해 도커 허브에 푸쉬하는 과정이다. **Docker**, **Nginx**, **Github Actions**를 이용했다.

[**\[React\] Docker + Nginx + Github Actions 프로젝트 배포하기 (1)**](https://9yujin.tistory.com/49)

deploy 레포지토리에 액션이 트리거되면 도커 컴포즈를 이용해 백엔드, 클라이언트, nginx 세개의 이미지를 받아와 실행한다.

자세한 기록은 위의 기록으로.

![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbAFRAF%2FbtrIekuHNVq%2F6p0LYKReeZo8K34mYSUpIk%2Fimg.png)
_장장 10트만에 성공_
