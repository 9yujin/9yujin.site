...
# React transition group 라우팅 트랜지션 (2) - 디테일 잡기
...
[\[뱅키즈\] 6. React transition group 라우팅 트랜지션 (1) - 도입하기](http://localhost:3000/devlog/bankidz/react-transition-group_221015)

## **1. 기존의 라우팅 구조 때문에 생겼던 문제**
...
![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FBuW7l%2FbtrQeB4aOZJ%2FBSMe7jtNDYykEG4DC0di1K%2Fimg.png)

그랬더니 이런 문제가 생겼음.

<br />

![](https://blog.kakaocdn.net/dn/oBaIj/btrQd7WM34l/kac0ViDKYWdtLsXka7sUXk/img.gif)

'돈길 걷기'에서 걷고 있는 돈길이 없을 때 '돈길 계약하기'로 넘어갈 때 애니메이션이 적용되지 않았다. 되게 당연한거였다. 각각 라우터마다 트랜지션 그룹을 적용하려고 했고, '/walk'과 '/create'는 다른 라우터에 있었다.

```tsx filename="ServiceRouter.tsx"
const ServiceRouter = () => {
...
![](https://blog.kakaocdn.net/dn/o5EjR/btrQfJ8fyKx/MUTLRtE5fevmao1FUti4V1/img.gif)

그러고 생긴 또다른 문제.

## **2. 페이지 순서에 따라 다른 애니메이션을 보여주기**
...
![](https://blog.kakaocdn.net/dn/vNB4Z/btrQfeOdh1p/arbqtZgdRendcIVvRu1Tt0/img.gif)
...
## **3. 라우팅이 아닌, state 변경에 따른 애니메이션 넣기**

돈길 계약하기 과정과 서비스 이용 방법 등에 사용한다. 페이지는 고정되고 그 안에서 내부 컴포넌트에 트랜지션을 주고 싶다. 말로 쓰니까 이해가 잘 안돼서, 결과 먼저.

<br />

![](https://blog.kakaocdn.net/dn/DytoR/btrQfdIyBOl/CQRBcCC5sk6L6RJa8Db78k/img.gif)

꽤 이쁘다.

<br />

```tsx filename="SlideTransition.tsx"
